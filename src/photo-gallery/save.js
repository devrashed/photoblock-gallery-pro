      ...
      <div {...blockProps}>
        ...
        <div className="my-gallery__lightbox-modal" style={{ display: 'none' }}>
          ...
          <div className="my-gallery__lightbox-container">
            <button className="my-gallery__lightbox-close" aria-label="Close lightbox">×</button>
            <button className="my-gallery__lightbox-prev" aria-label="Previous image">❮</button>
