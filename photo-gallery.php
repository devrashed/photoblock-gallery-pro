 ...
 */
function create_block_photo_gallery_block_init() {
	/**
...
add_action( 'init', 'create_block_photo_gallery_block_init' );

function photo_gallery_block_register_assets() {
    // Frontend style
    wp_register_style(
        'photo-gallery-style',
...
add_action( 'init', 'photo_gallery_block_register_assets' );
